        ...
        <div className='minting--option'>
            ...
            <div className='contract--details'>
                <div className='nft--counter'>
                    <button className='contract--details-btn' onClick={subCount} disabled={loading}>
                        <svg
                            width="16"
                            height="2"
                            viewBox="0 0 16 2"
                    ...
                    <button className='contract--details-btn' onClick={addCount} disabled={loading}>
                        <svg
                            width="16"
                            height="16"
                            viewBox="0 0 16 16"
